<x-app-layout>
    ...
    <form action="{{url('/receipe')}}" method="POST" enctype="multipart/form-data">
        ...
        <label for="file">
            <input type="file" name="file" placeholder="fichier" id="file" accept="image/png, image/jpeg" value="{{ old('file') }}" class="" /><span class="mandatory">*</span>
        </label>
        ...
        <label for="ingredients">
            ...
            <textarea name="ingredients" id="ingredients" placeholder="Ingredients" value="{{ old('ingredients') }}"cols="30" rows="10"></textarea>
        </label>
        <label for="description">
            ...
            <textarea name="description" id="description" placeholder="description" value="{{ old('description') }}"cols="30" rows="10"></textarea>
        </label>
